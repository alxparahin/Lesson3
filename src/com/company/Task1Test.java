...
class Task1Test {
    ...
    @Test
    void getSum2() {
        task1.setVarB((byte)15);
        assertEquals(30, task1.getSum((byte) 5, (short) 10));
    }

    @Test
    void getMultiplication() {
        task1.setCounter((short)15);
        assertEquals(22500, task1.getMultiplication(15, (long) 100));
    }
    ...
    @Test
    void getMaxNumber() {
        assertEquals(1, task1.getMaxNumber(1,0));
        assertNotEquals(0, task1.getMaxNumber(1,0));
    }

    @Test
    void isCharA() {
        assertEquals(true, task1.isCharA('A'));
        assertNotEquals(true, task1.isCharA('a'));
        assertEquals(false, task1.isCharA('a'));
        assertNotEquals(false, task1.isCharA('A'));
    }

    @Test
    void isCharNumber() {
        assertEquals(true, task1.isCharNumber('0'));
        assertNotEquals(true, task1.isCharNumber('a'));
    }

    @Test
    void checkZeroDivision() {
        //assertEquals(void, task1.checkZeroDivision(0));
    }
